...
public final class SpecificCountryQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, native: String, capital: String? = nil, currency: String? = nil, emoji: String, emojiU: String, states: [State]) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "native": native, "capital": capital, "currency": currency, "emoji": emoji, "emojiU": emojiU, "states": states.map { (value: State) -> ResultMap in value.resultMap }])
      }
